...
#include "ExposureFilterPass.h"
#include "../../../shader/vulkan/common/COMMON_RECTANGLE_PASS_VERT.h"
#include "../../../shader/vulkan/ExposureFilterPass/EXPOSURE_FILTER_PASS_FRAG.h"

#if OPENGL_DESKTOP
#include "../../../shader/gl/common/COMMON_RECTANGLE_PASS_VERT.h"
#include "../../../shader/gl/ExposureFilterPass/EXPOSURE_FILTER_PASS_FRAG.h"
#else
#include "../../../shader/gles/common/COMMON_RECTANGLE_PASS_VERT.h"
#include "../../../shader/gles/ExposureFilterPass/EXPOSURE_FILTER_PASS_FRAG.h"
#endif
...
ExposureFilterPass::ExposureFilterPass(HyperGpu::GpuDevice *pDevice): BasePass(pDevice) {
    ...
    envInfo.shaderInfo = HyperGpu::ShaderInfo{
        ...
        .pSpvFragCode	   = EXPOSURE_FILTER_PASS_FRAG_SPV.data(),
        .spvFragCodeSize = EXPOSURE_FILTER_PASS_FRAG_SPV.size(),

        .pGlVertexCode = COMMON_RECTANGLE_PASS_VERT_STR,
        .pGlFragCode = EXPOSURE_FILTER_PASS_FRAG_STR,
    };
...
ExposureFilterPass::~ExposureFilterPass() {
    m_pLocalInfoBuffer->SubRef();
}

void ExposureFilterPass::SetTargetImage(HyperGpu::Image2D *pImage) {
    UpdateImageBinding("uTex", pImage);
}

void ExposureFilterPass::SetLocalInfo(float exposure) {
    LocalInfo info{};
