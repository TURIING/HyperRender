...
function(COMPILE_SHADER shader_file output_dir)
    ...
    # 调用 spriv-cross 编译 spv 文件
    execute_process(
            COMMAND ${SPIRV_CROSS} --version 420 --es ${output_file_spv} --output ${output_file_gl}
            RESULT_VARIABLE result
            OUTPUT_VARIABLE output
            ERROR_VARIABLE error
    )
...
function(TRANSFORM_RESULT_GL GL_FILE OUTPUT_DIR)
    ...
    string(TIMESTAMP CURRENT_TIME "%Y-%m-%d %H:%M:%S")
    set(OUTPUT_FILE_HEADER "#pragma once\n// This file is automatically generated, please do not alter it.\n// ${CURRENT_TIME}\n")
    set(OUTPUT_FILE_DECLARE "inline auto ${OUTPUT_NAME} =\n")
